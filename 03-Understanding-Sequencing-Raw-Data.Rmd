...
**NEEDS UPDATED commands and docker explanations!**
...
#### Viewing entire file
```{bash, eval = FALSE}
cat data/Teichmann_2i_2_2_2.fastq
```

#### Viewing first 10 lines

```{bash, eval = FALSE}
head data/Teichmann_2i_2_2_2.fastq
```

#### Stream Viewing with less command

```{bash, eval = FALSE}
less data/Teichmann_2i_2_2_2.fastq
```
...
```{bash, eval = FALSE}
samtools view data/pbmc_1k_protein_v3_possorted_genome_bam.bam | head
```

#### Stream Viewing with less command

```{bash, eval = FALSE}
samtools view data/pbmc_1k_protein_v3_possorted_genome_bam.bam | less
```

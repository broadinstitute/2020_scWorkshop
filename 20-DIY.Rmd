...
You can start by filtering extreme outliers:
```{r filter data}
seurat <- subset(seurat, subset = nFeature_RNA > 350 & nFeature_RNA < 9000 & n.exp.hkgenes > 60)
```
And normalize:
```{r normalize}
...
seurat.malignant.MGH107<- subset(seurat_malignant, subset = tumor_name == "MGH107neg") #keep only malignant MGH107 cells
seurat.malignant.MGH44<- subset(seurat_malignant, subset = tumor_name == "MGH44") #keep only malignant MGH44 cells
```
